...
public class EntityTinyCaveSpider extends EntitySpider
{
    public EntityTinyCaveSpider(World worldIn)
    {
        super(worldIn);
        this.setSize(0.7F, 0.5F);
    }

    public static void registerFixesTinyCaveSpider(DataFixer fixer)
    {
        EntityLiving.registerFixesMob(fixer, "TinyCaveSpider");
    }
